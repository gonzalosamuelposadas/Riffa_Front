...
import { loginSchema, type LoginFormData, Input, Loading } from '@shared'
    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-800 to-slate-900 dark:from-slate-900 dark:to-black flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-2xl p-8 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-slate-800 dark:text-white">RifaApp</h1>
          <p className="text-slate-500 dark:text-slate-400 mt-1">Inicia sesion en tu cuenta</p>
        </div>
        ...
        {(urlError || serverError) && (
          <div className="mb-6 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg flex items-center gap-3 text-red-700 dark:text-red-400">
            ...
            <p className="text-sm">
              {serverError || 'Error al iniciar sesion. Intenta de nuevo.'}
            </p>
          </div>
        )}
        ...
        <div className="mt-6 text-center space-y-2">
          ...
          <Link
            href="/"
            className="inline-block text-sm text-slate-400 dark:text-slate-500 hover:text-slate-600 dark:hover:text-slate-300 transition-colors"
          >
            Volver al inicio
          </Link>
        </div>
