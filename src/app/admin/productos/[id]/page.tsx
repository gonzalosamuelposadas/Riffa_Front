  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setImages(product.images.length > 0 ? product.images : [{ url: '', alt: '' }])
        setVariants(
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={variant.price ?? ''}
                      onChange={(e) =>
                        handleVariantChange(index, 'price', e.target.value ? parseFloat(e.target.value) : null)
                      }
                      min="0"
                      step="0.01"
                      className="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-slate-700 text-slate-800 dark:text-white"
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      value={variant.size || ''}
                      onChange={(e) => handleVariantChange(index, 'size', e.target.value || null)}
                      className="w-full px-3 py-2 text-sm border border-slate-300 dark:border-slate-600 rounded-lg focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white dark:bg-slate-700 text-slate-800 dark:text-white"
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <input
                        type="text"
                        value={variant.color || ''}
                        onChange={(e) => handleVariantChange(index, 'color', e.target.value || null)}
